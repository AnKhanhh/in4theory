...
public class HuffmanEncoding {
    public static void main(String[] args) {
        ...
        System.out.println(CharInName.toString());
        ...
        while(NodeList.size()!=1){
            ...
            for(int i = 0; i < NodeList.size(); i++){
                for (int e = NodeList.size()-1; e >= 1; e--) if(NodeList.get(e).prob < NodeList.get(e-1).prob){
        ...
        //for(int i = 0; i < NodeList.size(); i++) System.out.println("Value: " + S tring.valueOf(NodeList.get(i).Value) + " Probability: " + String.valueOf(NodeList.get(i).prob));
    }
}
